...
class CrysetNode {
    ...
    getFees() {
        return __awaiter(this, void 0, void 0, function* () {
            const mempool = yield this.getRawMempool();
            const info = yield this.getMempoolInfo();
            const high = (yield this.calculateHighPriorityFee(mempool.data)) * 100000000; //10mins
